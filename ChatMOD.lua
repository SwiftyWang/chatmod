...
-------------------------------------------------
	...
	local Hardcore = {
            ...
            ['(.+) has reached level (.+) in Hardcore mode! As they ascend towards immortality, their glory grows! However, so too does the danger they face.'] = '|cfff86256[HC]|r %1克服万难成功晋升到%2级,飞升不要太简单！',
